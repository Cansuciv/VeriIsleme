...
3. Apache NiFi kuruldu ve kullanici adi/parola ile girildi. Aþaðýdaki akis kuruldu:
...
- Apache NiFi: `https://localhost:8443` (HTTP acilmaz; tarayici uyarisinda devam edilmelidir)
...
### Docker Compose ile ayaða kaldirma
